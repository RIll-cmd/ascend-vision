...
it with offline Windows TTS; background mode remains silent.
...
For an existing Phase 3 environment, skip the environment-creation command.
...
offline. The dashboard remains Phase 5.
...
Historical Phase 1/2/3 instructions and measurements remain under `docs/`.
